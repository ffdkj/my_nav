    ...
    >
        ...
        {#each board.pages as p, i (p.id)}
          <li class="flex items-center gap-2">
            <input
              ...
              class="min-w-0 flex-1 rounded-lg bg-white/10 px-3 py-1.5 text-sm ring-1 ring-white/15 outline-none focus:ring-2 focus:ring-accent-500"
              aria-label="页面名称"
            />
            <button
              type="button"
              onclick={() => move(i, -1)}
              disabled={i === 0}
              class="cursor-pointer rounded-lg px-2 py-1 text-xs text-white/60 hover:bg-white/10 disabled:opacity-30"
              aria-label="上移"
            >
              &#8593;
            </button>
            ...
            <button
              ...
              class="cursor-pointer rounded-lg px-2 py-1 text-xs text-red-300 hover:bg-red-500/20 disabled:opacity-30"
      ...
      <div class="mb-4 flex gap-2">
        <input
          bind:value={newName}
          placeholder="新页面名称"
          class="min-w-0 flex-1 rounded-lg bg-white/10 px-3 py-2 text-sm ring-1 ring-white/15 outline-none focus:ring-2 focus:ring-accent-500"
          aria-label="新页面名称"
          onkeydown={(e) => {
